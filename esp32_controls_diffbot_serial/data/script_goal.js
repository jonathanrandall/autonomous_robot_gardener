...
function onMessage(event) {
    ...
    document.getElementById("slider2").value = myObj.goal_dist;
    document.getElementById("textSliderValue").innerHTML = myObj.goal_dist;
...
function update_motor_status(element) {
    ...
    obj_2_update.action = "goal_status";
